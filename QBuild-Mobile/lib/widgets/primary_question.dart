...
class PrimaryQuestion extends StatefulWidget {
  ...
  @override
  State<PrimaryQuestion> createState() => _PrimaryQuestionState();
}

class _PrimaryQuestionState extends State<PrimaryQuestion> {
  ...
  Widget build(BuildContext context) {
    debugPrint('PrimaryQuestion build - response: ${widget.response}, isEnabled: ${widget.isEnabled}');
          ...
          Container(
            ...
            child: const Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'This question is currently disabled',
                    style: TextStyle(
                      fontSize: 12,
